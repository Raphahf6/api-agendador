...
# Certifique-se que o modelo Professional está no core/models.py
from core.models import Professional 

router = APIRouter(prefix="/admin/equipe", tags=["Equipe"])

# 🌟 MUDANÇA AQUI: Removi a "/" de dentro do @router.post("")
...
# 🌟 MUDANÇA AQUI: Removi a "/" de dentro do @router.get("")
